...
extern xSemaphoreHandle scheduleSemaphore;
/////
...
//xOLEDMessage xOLEDMessage;
    ...
    if( c )
    {
        ...
        *c = 0x00;
        ...
        // added by Young
        if( (cMessageForDisplay[0] == '-') && ( cMessageForDisplay[1] == 'P')) {

              suspend = 0;
              
              
        } else if( (cMessageForDisplay[0] == '-') && (cMessageForDisplay[1] == 'S')){

              suspend = 1;
        
		} else if( (cMessageForDisplay[0] == '-') && (cMessageForDisplay[1] == 'D')){
		...
		} else if( (cMessageForDisplay[0] == '-') && (cMessageForDisplay[1] == 'M')){
